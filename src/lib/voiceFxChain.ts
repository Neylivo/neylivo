// v1.337.0: движок голосовых эффектов. Отделён от списка (voiceFx.ts) намеренно:
// сюда тянется работа с WebAudio, а нужна она только когда идёт звонок.
import type { VoiceEffect } from './voiceFx'
