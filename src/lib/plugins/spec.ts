...
/** Короткая просьба, с которой удобно начать разговор с ИИ. */
export const AI_PROMPT_PREFIX =
  'Ты пишешь плагин для мессенджера Ponoi. Ниже — полное описание формата. ' +
  'Прочитай его и напиши плагин, который делает вот что: [ОПИШИ СВОИМИ СЛОВАМИ, ЧТО ХОЧЕШЬ]. ' +
  'Ответь только готовым файлом, без пояснений.\n\n'
