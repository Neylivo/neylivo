...
export const AI_PROMPT_PREFIX =
  ...
  'если чего-то не хватает, чтобы её собрать, — переспроси, а потом отдай готовый файл.\n\n' +
...
export const AI_BOT_PROMPT_PREFIX =
  ...
  'Когда человек расскажет — отдай готовый код целиком, с проверкой подписи, и скажи, какие нужны ' +
