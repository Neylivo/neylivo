...
обрабатывает само приложение — поэтому спрашивать место надо у него:
    ...
    // { x, y, width, height, mode, max, screenWidth, screenHeight } либо null
    ...
    ponoi.on('app', (e) => {
      // { id, mode, open, x, y, width, height } — приходит и при перемещении:
      // кадрами, пока человек тянет окно, и один раз, когда отпустил
    })
