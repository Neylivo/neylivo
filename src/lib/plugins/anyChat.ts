...
//
// НЕТ: личной переписки. И это не «руки не дошли». Личные сообщения в NeyLivo
...
// делалось. Поэтому личка остаётся через neylivo.messages.send, который работает
 ...
 *
 * neylivo.channels(serverId) уже есть, но он про один сервер и требует знать его
