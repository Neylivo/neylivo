...
// v1.413.0: сами проверки переехали в lib/mentions.ts — они нужны и там, где
// разметчик не нужен вовсе (уведомления), а тянуть его целиком ради одной
// строковой проверки означало возить его в стартовой сборке.
export { mentionsHere, mentionsUser, mentionsRoleName } from './mentions'
