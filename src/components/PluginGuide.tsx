        ...
        <div className="pg-body">
          ...
          <div className="pg-main"><div className="pg-inner">
            ...
            {tab === 'rules' && <>
              ...
              <p className="pg-note">
                Проще всего начать не с кода, а с мастерской: Настройки → <b>Мастерская</b>.
                Проект из файлов, живой показ рядом и консоль с ошибками. Есть заготовка
                «3D-игра» — сцена, свет, тени, ходьба на WASD и осмотр мышью.
              </p>
