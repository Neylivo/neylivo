        ...
        {tab === 'overview' && <>
          ...
          {isVoice && <>
            ...
            {/* v1.332.0: выбор региона сохранялся и не читался нигде — и читаться
                ему неоткуда: сервер связи у NeyLivo ровно один, выбирать не из чего.
            ...
            <div className="cset-hint">Сервер связи у NeyLivo один, поэтому выбирать регион не из чего — все подключаются к нему. Настройка появится, когда серверов станет несколько.</div>
          </>}
        </>}
        {tab === 'perms' && <>
