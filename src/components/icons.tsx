...
export function Icon({ name, size, className, style }: { name: string; size?: number; className?: string; style?: React.CSSProperties }) {
  ...
  switch (name) {
    ...
    case 'mic-off': return <svg {...p}><line className="ic-strike" x1="2" y1="2" x2="22" y2="22"/><path d="M9 9v3a3 3 0 0 0 5.12 2.12M15 9.34V4a3 3 0 0 0-5.94-.6"/><path d="M17 16.95A7 7 0 0 1 5 12v-2m14 0v2a7 7 0 0 1-.11 1.23"/><line x1="12" y1="19" x2="12" y2="23"/></svg>
    case 'headphones': return <svg {...p}><path className="hp-arc" d="M3 18v-6a9 9 0 0 1 18 0v6"/><path className="hp-r" d="M21 19a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3z"/><path className="hp-l" d="M3 19a2 2 0 0 0 2 2h1a2 2 0 0 0 2-2v-3a2 2 0 0 0-2-2H3z"/></svg>
    case 'headphones-off': return <svg {...p}><line className="ic-strike" x1="2" y1="2" x2="22" y2="22"/><path d="M3 18v-6a9 9 0 0 1 12.09-8.44M21 15.15V12a9 9 0 0 0-.35-2.5"/><path d="M6 14H5a2 2 0 0 0-2 2v3a2 2 0 0 0 2 2h1a2 2 0 0 0 2-2v-3"/><path d="M18 14h1a2 2 0 0 1 2 2v3"/></svg>
    ...
    case 'pin': return <svg {...p}><line x1="12" y1="17" x2="12" y2="22"/><path d="M5 17h14l-1.5-3V6a2 2 0 0 0-2-2h-5a2 2 0 0 0-2 2v8z"/></svg>
    case 'phone': return <svg {...p}><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.9.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
    // v1.377.0: «положить трубку» — канонический силуэт: трубка, прижатая вниз,
    // с расходящимися в стороны «плечами».
    //
    // Два прошлых захода были мимо. Сначала стояла трубка, перечёркнутая линией,
    // — она читалась как сломанная иконка. Потом я повернул обычный контурный
    // телефон на 135°, и он превратился в лежащую на боку дугу, вдобавок
    // вылезающую за края.
    //
    // Здесь форма нарисована сразу в нужной позе, без поворотов: ничего не
    // обрезается, и узнаётся она мгновенно — так эту кнопку рисуют везде.
    case 'phone-off': return <svg {...p} fill="currentColor" stroke="none"><path d="M12 9c-1.6 0-3.15.25-4.6.72v3.1c0 .39-.23.74-.56.9-.98.49-1.87 1.12-2.66 1.85-.18.18-.43.28-.7.28-.28 0-.53-.11-.71-.29L.29 13.08c-.18-.17-.29-.42-.29-.7 0-.28.11-.53.29-.71C3.34 8.78 7.46 7 12 7s8.66 1.78 11.71 4.67c.18.18.29.43.29.71 0 .28-.11.53-.29.71l-2.48 2.48c-.18.18-.43.29-.71.29-.27 0-.52-.11-.7-.28-.79-.74-1.69-1.36-2.67-1.85-.33-.16-.56-.5-.56-.9v-3.1C15.15 9.25 13.6 9 12 9z"/></svg>
    // v1.197.0: закрашенная трубка со стрелкой — для истории звонков (как в Discord):
    // успешный/исходящий — стрелка вверх-вправо (зелёный), пропущенный — вниз-вправо (серый).
    // Трубка — та же геометрия, что у 'phone' выше (уже проверена), просто залита и
    // уменьшена в нижний левый угол, чтобы освободить верхний правый угол под стрелку.
    case 'phone-up': return <svg {...p}>
      <path fill="currentColor" stroke="none" transform="translate(-1 4) scale(.75)" d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.9.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z"/>
      <line x1="15" y1="9" x2="22" y2="2"/><polyline points="16 2 22 2 22 8" fill="none"/>
    </svg>
    case 'phone-down': return <svg {...p}>
      <path fill="currentColor" stroke="none" transform="translate(-1 4) scale(.75)" d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.9.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z"/>
      <line x1="15" y1="2" x2="22" y2="9"/><polyline points="22 3 22 9 16 9" fill="none"/>
    </svg>
    case 'crown': return <svg {...p}><path d="M2 6l4 4 6-7 6 7 4-4-2 13H4z"/></svg>
    case 'gamepad': return <svg {...p}><line x1="6" y1="12" x2="10" y2="12"/><line x1="8" y1="10" x2="8" y2="14"/><line x1="15" y1="13" x2="15.01" y2="13"/><line x1="17" y1="11" x2="17.01" y2="11"/><path d="M17.32 5H6.68a4 4 0 0 0-3.98 3.59C2.6 9.42 2 14.46 2 16a3 3 0 0 0 3 3c1 0 1.5-.5 2-1l1.41-1.41A2 2 0 0 1 9.83 16h4.34a2 2 0 0 1 1.41.59L17 18c.5.5 1 1 2 1a3 3 0 0 0 3-3c0-1.54-.6-6.58-.68-7.26A4 4 0 0 0 17.32 5z"/></svg>
    case 'close': case 'x': return <svg {...p}><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
    ...
    case 'threads': return <svg {...p}><path d="M7 4v9a4 4 0 0 0 4 4h6"/><polyline points="14 13 18 17 14 21"/><line x1="7" y1="4" x2="13" y2="4"/></svg>
    ...
    case 'message': return <svg {...p}><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"/></svg>
    ...
    case 'smile': return <svg {...p}><circle cx="12" cy="12" r="10"/><path className="sm-mouth" d="M8 14s1.5 2 4 2 4-2 4-2"/><line className="sm-eye" x1="9" y1="9" x2="9.01" y2="9"/><line className="sm-eye" x1="15" y1="9" x2="15.01" y2="9"/></svg>
    ...
    case 'bell-off': return <svg {...p}><path d="M13.73 21a2 2 0 0 1-3.46 0"/><path d="M18.63 13A17.89 17.89 0 0 1 18 8"/><path d="M6.26 6.26A5.86 5.86 0 0 0 6 8c0 7-3 9-3 9h14"/><path d="M18 8a6 6 0 0 0-9.33-5"/><line x1="2" y1="2" x2="22" y2="22"/></svg>
    ...
    case 'id-card': return <svg {...p}><rect x="2" y="4" width="20" height="16" rx="2"/><circle cx="8" cy="12" r="2.5"/><line x1="14" y1="10" x2="18" y2="10"/><line x1="14" y1="14" x2="18" y2="14"/></svg>
    ...
    case 'skip-back': return <svg {...p}><polygon points="19 20 9 12 19 4 19 20"/><line x1="5" y1="19" x2="5" y2="5"/></svg>
    ...
    case 'screen-share': return <svg {...p}><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>
    ...
    case 'zoom-in': return <svg {...p}><circle cx="11" cy="11" r="7"/><line x1="21" y1="21" x2="16.65" y2="16.65"/><line x1="11" y1="8" x2="11" y2="14"/><line x1="8" y1="11" x2="14" y2="11"/></svg>
    // v1.431.0: «отдалить» — у просмотрщика появилась вторая кнопка, а рисовать
    // её было нечем: неизвестное имя иконки отдаёт пустоту, и кнопка была бы
    // невидимой (см. default ниже).
    case 'zoom-out': return <svg {...p}><circle cx="11" cy="11" r="7"/><line x1="21" y1="21" x2="16.65" y2="16.65"/><line x1="8" y1="11" x2="14" y2="11"/></svg>
    ...
    case 'film': return <svg {...p}><rect x="2" y="2" width="20" height="20" rx="2.18" ry="2.18"/><line x1="7" y1="2" x2="7" y2="22"/><line x1="17" y1="2" x2="17" y2="22"/><line x1="2" y1="12" x2="22" y2="12"/><line x1="2" y1="7" x2="7" y2="7"/><line x1="2" y1="17" x2="7" y2="17"/><line x1="17" y1="17" x2="22" y2="17"/><line x1="17" y1="7" x2="22" y2="7"/></svg>
    case 'soundboard': return <svg {...p}><rect x="3" y="3" width="7" height="7" rx="1.5"/><rect x="14" y="3" width="7" height="7" rx="1.5"/><rect x="3" y="14" width="7" height="7" rx="1.5"/><path d="M14 17.5h7"/><path d="M17.5 14v7"/></svg>
    ...
    // v1.536.0: для списка устройств — телефон и компьютер.
    case 'smartphone': return <svg {...p}><rect x="7" y="2" width="10" height="20" rx="2" ry="2"/><line x1="11" y1="18" x2="13" y2="18"/></svg>
