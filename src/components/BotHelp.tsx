...
// 1) Заведи приложение в «Мои приложения», скопируй ID и токен.
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal help-modal" onClick={e => e.stopPropagation()}>
        ...
        <div className="help-tbl">
          <div><code>1</code><span>«Мои приложения» → создать бота. Токен и секрет показываются <b>один раз</b> — сохрани их сразу, второй раз их не покажет никто.</span></div>
