...
export function ForumView({
  ...
  // Перешли в другой форум — сбрасываем поиск и выбранные теги. Теги у каждого
  // канала свои, и оставленный фильтр по чужому тегу спрятал бы вообще всё,
  // причём с виду без причины: такой кнопки в новом канале даже нет.
  useEffect(() => { setQ(''); setTagFilter([]) }, [channel.id])
