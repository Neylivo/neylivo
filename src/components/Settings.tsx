...
function E2eeSection() {
  ...
  return <>
    ...
    <Row title="Шифровать разговор в звонках"
      desc="Голос и видео становятся нечитаемыми для сервера. Работает только в личных звонках один-на-один и только если у собеседника эта версия и та же настройка. Выключено по умолчанию: включи и проверь звонок, прежде чем полагаться.">
