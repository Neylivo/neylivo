// v1.420.0: внутренний ИИ Ponoi Music — слушает трек и сам расставляет текст.
//
...
export const AI_CREDIT = '[by:Ponoi — распознано на слух, слова могут быть с ошибками]'
export const AI_CREDIT_TIMED = '[by:Ponoi — метки времени расставлены на слух]'
